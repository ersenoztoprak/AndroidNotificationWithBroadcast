...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> friendList = getArguments().getIntegerArrayList("friends");
		Integer[] resourceIDs = new Integer[friendList.size()];
		resourceIDs = friendList.toArray(resourceIDs);
